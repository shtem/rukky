...
class AssignASTNode(ExprASTNode):
    def __init__(self, token, var: IdentifierASTNode, value: ExprASTNode, index: ExprASTNode):
        self.token = token
        self.var = var
        self.value = value
        self.index = index
...
class IfStmtASTNode(StmtASTNode):
    def __init__(self, token, cond: ExprASTNode, ifBody: StmtBlockASTNode, elifStmts: list[ElifStmtASTNode], elseBody: StmtBlockASTNode):
        self.token = token
        self.cond = cond
        self.ifBody = ifBody
...
class ForStmtASTNode(StmtASTNode):
    def __init__(self, token, counter: IdentifierASTNode, start: ExprASTNode, end: ExprASTNode, increment: ExprASTNode, forBody: StmtBlockASTNode):
        self.token = token
...
class FunctionASTNode(ASTNode):
    def __init__(self, token, funcName: IdentifierASTNode, params: list[IdentifierASTNode], funcBody: StmtBlockASTNode):
        self.token = token
